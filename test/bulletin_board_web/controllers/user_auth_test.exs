defmodule BulletinBoardWeb.UserAuthTest do
  use BulletinBoardWeb.ConnCase, async: true

  alias BulletinBoard.Users
  alias BulletinBoardWeb.UserAuth
  import BulletinBoard.UsersFixtures

  @remember_me_cookie "_bulletin_board_web_user_remember_me"

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BulletinBoardWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BulletinBoardWeb.Endpoint.subscribe(live_socket_id)
